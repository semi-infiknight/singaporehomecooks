...
| P2-01 | Customer web Gourmeat parity | **In progress** — profile `SHCVisualBentoTile` Gourmeat; checkout success `GourmeatScreenHeader`; PDP outline button soft shadow |
