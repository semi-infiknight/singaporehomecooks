...
export const HIDE_MOBILE_TAB_BAR =
  /^\/(?:profile|checkout|product\/|orders\/(?:[^/]+|manage)|chat\/|request|location|search|drops\/|cook\/[^/]+(?:\/ratings)?|tiffin\/(?:kitchen|confirm|planner|manage|calendar|pause|recharge|menu|subscriptions))(?:\/|$)/;
