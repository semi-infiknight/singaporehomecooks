        ...
        <>
          ...
          {belowMinimum && (
            ...
            <p
              ...
              className="mb-4 rounded-xl border border-border bg-[var(--shc-peach-50)] p-3 text-sm font-semibold text-foreground"
                  ...
                  <li key={idx} className="py-3 px-4 flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-xs text-muted-foreground font-medium tabular-nums">
                        ...
                        {cartCopy.linePrice(it.qty, it.price.toFixed(2))}
