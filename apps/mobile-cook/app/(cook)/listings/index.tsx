    ...
    <ScrollView style={{ flex: 1, backgroundColor: shcColors.background, padding: 16 }}>
      ...
      {step === 3 && (
        <ListingWizardStep step={3} title="3-Tier Ingredients + Heritage">
          ...
          <Pressable onPress={async () => { const tips = await getPhotoTips(); setPhotoTips((tips as { tips?: string[] }).tips || []); setShowPhotoTips(true); }} testID="photo-tips-btn"><Text style={{ color: shcColors.primary, marginTop: 6 }}>📸 Show 3 Photo Quality Tips</Text></Pressable>
