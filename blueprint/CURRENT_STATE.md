...
| **Paper wireframe IA** | ✅ Wave 1–3 | W1 Account/trust/cart/duration · **W2** Pause/Recharge/card states · **W3** Cook tiffin OS (metrics + date picker publish/cancel), standalone kitchen ratings (`/cook/[slug]/ratings`), dashboard Tiffin OS entry |
