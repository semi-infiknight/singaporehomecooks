...
| **Paper wireframe IA** | ✅ Wave 1–4 | W1–3 done · **W4** Kitchen social proof + open status; subscribe trust chips; confirm steps; planner sticky/errors; calendar empty; manage ledger shell; cook `subscriber_count` on config |
